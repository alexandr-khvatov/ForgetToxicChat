...
LEXICON_COMMANDS: dict[str, str] = {
    '/help': 'Cписок команд бота',
    '/ping':            'ping',
    '/setup': 'Настройки чата',
    '/mute': 'Перевести пользователя в режим «только чтение»',
    '/unmute': 'Перевести пользователя из режима «только чтение»',
    '/ban': 'Заблокировать пользователя',
    '/unban': 'Разблокировать пользователя',
    '/admins_update': 'Обновить список админов',
    # '/add_sw': 'Добавить стоп:слово',
}
